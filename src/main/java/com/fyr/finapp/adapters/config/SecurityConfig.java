...
import com.fyr.finapp.adapters.driven.persistence.jpa.DatabaseUserDetailsService;
import com.fyr.finapp.adapters.driven.persistence.jpa.repository.UserJpaRepository;
import com.fyr.finapp.adapters.driven.security.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    private final List<String> allowedOrigins = List.of("http://localhost:3000", "https://finapp-web-nine.vercel.app");
    ...
    public UserDetailsService userDetailsService(UserJpaRepository userJpaRepository) {
        return new DatabaseUserDetailsService(userJpaRepository);
    }
